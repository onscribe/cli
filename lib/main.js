...
*/
	...
	initAuth: function( callback ){
		...
		if( oauth && oauth.access_token ){
			...
			var hour = 3600000;
			var day = 86400000;
			if( oauth.expires < now + day ) return self.getToken( callback ); // expire a day earlier...
	...
	subscription: function( id, options ){
		var params = {};
		if( id ) params.id = id ;

		// read the product collection for the current user: /subscriptions
		params.name = ( options.list ) ? "subscriptions" : "subscription";
